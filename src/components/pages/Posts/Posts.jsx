              ...
              >
                ...
                <div class="flex justify-content-center pt-4">
                  ...
                  >
                    <button
                      aria-label="View"
                      class="text-white p-button p-component p-button-outlined border-round-sm bg-black-alpha-90 border-transparent transition-colors transition-duration-100 bg-blue-500 hover:bg-orange-500 text-white hover:text-white"
                    >
