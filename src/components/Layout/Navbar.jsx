  ...
  return (
    <div className="px-4 flex align-items-center justify-content-between relative lg:static lg:w-full p-0">
      <Link to="/dashboard" className="no-underline">
        <h3 className="text-3xl font-bold text-900 cursor-pointer">
          Foodies
      ...
      <div className="align-items-center flex-grow-1 lg:justify-content-end lg:flex absolute lg:static w-full left-0 top-100 px-6 lg:px-5 z-3 shadow-2 lg:shadow-none hidden">
        <ul className="list-none p-0 m-0 flex lg:align-items-center text-white select-none flex-column lg:flex-row cursor-pointer">
          <li className="relative">
            <Link
              to="/dashboard"
              className="no-underline p-ripple text-color no-underline flex px-0 lg:px-5 py-3 align-items-center hover:text-700 font-medium transition-colors transition-duration-150"
            >
              <span>Home</span>
            </Link>
          </li>
          <li>
            <Link
              to="/dashboard/about"
              className="no-underline p-ripple text-color no-underline flex px-0 lg:px-5 py-3 hover:text-700  font-medium transition-colors transition-duration-150"
            >
              <span>About</span>
        ...
        <div className="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0 lg:ml-5">
          ...
          >
            ...
            <span className="p-button-label p-c text-900  text-white">
              Logout
            </span>
            <span role="presentation" className="p-ink"></span>
          </button>
